<x-admin-layout>
    <div class="space-y-8" x-data="problemForm()">
        <div>
            <h2 class="text-2xl font-bold font-outfit text-gray-900 dark:text-white">Create New Coding Problem</h2>
            <p class="text-sm text-gray-500 dark:text-gray-405">Configure problem text, execution parameters, tags, and grading test cases.</p>
        </div>

        <form action="{{ route('admin.problems.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="bg-white dark:bg-gray-900 p-6 sm:p-8 rounded-3xl border border-gray-150 dark:border-gray-855 shadow-sm space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="md:col-span-2 space-y-1.5">
                        ...
                        <input type="text" id="title" name="title" value="{{ old('title') }}" required placeholder="e.g. Two Sum"
                               class="w-full bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl text-sm focus:ring-blue-500 focus:border-blue-500 text-gray-905 dark:text-white" />
                    ...
                    <div class="space-y-1.5">
                        ...
                        <select id="difficulty" name="difficulty" required class="w-full bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl text-sm focus:ring-blue-500 focus:border-blue-500 text-gray-905 dark:text-white">
                ...
                <div class="space-y-1.5">
                    ...
                    <textarea id="description" name="description" rows="8" required placeholder="Write clear problem statement instructions here..."
                              class="w-full bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl text-sm focus:ring-blue-500 focus:border-blue-500 text-gray-905 dark:text-white">{{ old('description') }}</textarea>
            ...
            <div class="bg-white dark:bg-gray-900 p-6 sm:p-8 rounded-3xl border border-gray-150 dark:border-gray-855 shadow-sm space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <textarea id="input_format" name="input_format" rows="3" placeholder="Describe the variables and input lines..."
                                  class="w-full bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl text-sm focus:ring-blue-500 focus:border-blue-500 text-gray-905 dark:text-white">{{ old('input_format') }}</textarea>
                    </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <textarea id="output_format" name="output_format" rows="3" placeholder="Describe expected output formatting..."
                                  class="w-full bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl text-sm focus:ring-blue-500 focus:border-blue-500 text-gray-905 dark:text-white">{{ old('output_format') }}</textarea>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="md:col-span-1 space-y-1.5">
                        ...
                        <input type="text" id="constraints" name="constraints" value="{{ old('constraints') }}" placeholder="e.g. 1 <= N <= 10^5"
                               class="w-full bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl text-sm focus:ring-blue-500 focus:border-blue-500 text-gray-905 dark:text-white" />
                    </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="number" id="time_limit" name="time_limit" value="{{ old('time_limit', 1000) }}" required min="100" max="10000"
                               class="w-full bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl text-sm focus:ring-blue-500 focus:border-blue-500 text-gray-905 dark:text-white" />
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="number" id="memory_limit" name="memory_limit" value="{{ old('memory_limit', 256) }}" required min="16" max="1024"
                               class="w-full bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl text-sm focus:ring-blue-500 focus:border-blue-500 text-gray-905 dark:text-white" />
            ...
            <div class="bg-white dark:bg-gray-900 p-6 sm:p-8 rounded-3xl border border-gray-150 dark:border-gray-855 shadow-sm space-y-4">
                ...
                <div class="flex flex-wrap gap-4">
                    @foreach($tags as $tag)
                        <label class="inline-flex items-center space-x-2 bg-gray-50 dark:bg-gray-950 px-3 py-2 border border-gray-200 dark:border-gray-800 rounded-xl cursor-pointer select-none">
            ...
            <div class="bg-white dark:bg-gray-900 p-6 sm:p-8 rounded-3xl border border-gray-150 dark:border-gray-855 shadow-sm space-y-6">
                ...
                <div class="space-y-4">
                    <template x-for="(tc, index) in testCases" :key="index">
                        <div class="p-4 border border-gray-150 dark:border-gray-800 rounded-2xl bg-gray-50/50 dark:bg-gray-950/20 space-y-4 relative">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="space-y-1.5">
                                    ...
                                    <textarea :id="`tc_input_${index}`" :name="`test_cases[${index}][input]`" x-model="tc.input" rows="2" placeholder="e.g. 2\n3 5"
                                              class="w-full bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl text-xs font-mono focus:ring-blue-500 focus:border-blue-500 text-gray-905 dark:text-white"></textarea>
                                </div>
    ...
    <script>
        function problemForm() {
            return {
                testCases: @json(old('test_cases', [['input' => '', 'expected_output' => '', 'is_hidden' => false]])),
